                            ...
                            <div class="pull-right">
                                <div class="col-lg-2 col-xs-2">
                                    <button type="button" class="btn btn-md" onclick="remove_end_date()"
                                        style="width: 117px"> <i class="text-danger fa fa-times"></i> Remove</button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="pull-left" style="width: 75%;">
                                ...
                                <div class="col-lg-5 col-xs-12" id="edit_event_start_time_area" style="display: block">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="event_start_time" id="edit_event_start_time"
                                            value="" class="form-control time_pick" placeholder="Start Time">
                                    </div>
                                </div>
                            </div>
                            <div class="pull-right">
...
@section('content_script')
    <script>
        ...
        function get_data() {
            ...
            $.get(event_url, function(r) {
                ...
                $.each(ad, function(i, item) {
                    ...
                    html += '<a onclick="delete_event(' + ad[i].events_id +
                        ')"  class="btn btn-sm  btn-danger"    href="javascript:;" ><i class="fa fa-trash"></i></a> ';
                    html += '<a href="javascript:;"  onclick="edit_event(' + ad[i].events_id +
                        ')"    class="btn btn-sm btn-warning"><i class="fa fa-edit"></i> </a> ';
                    html += '<a href="javascript:;"  onclick="view_event(' + ad[i].events_id +
        ...
        function view_event(event_id) {
            ...
            $.get(single_event_url, function(r) {
                ...
                if (edata.id > 0) {
                    ...
                    var event_time = edata.event_start_date + ' ' + edata.event_start_time + ' - ' + edata
                        .event_end_date + ' ' + edata.event_end_time;
        ...
        function add_start_time() {
            ...
            var button =
                '<button type="button" title="Remove Start Time"   class="btn btn-md"  onclick="remove_start_time()"><i class="text-danger fa fa-times"></i>   <i class="text-danger fa fa-clock"></i> </button>';
        ...
        function remove_start_time() {
            ...
            var button =
                '<button type="button" title="Add Start Time"  class="btn btn-md"  onclick="add_start_time()"><i class="text-success fa fa-plus"></i>   <i class="text-success fa fa-clock"></i> </button>';
            $('#start_time_toggle').html(button);
        ...
        function add_end_time() {
            ...
            var button =
                '<button type="button"  title="Remove End Time"  class="btn btn-md"  onclick="remove_end_time()"><i class="text-danger fa fa-times"></i>   <i class="text-danger fa fa-clock"></i> </button>';
        ...
        function remove_end_time() {
            ...
            var button =
                '<button type="button" title="Add End Time"  class="btn btn-md"  onclick="add_end_time()"><i class="text-success fa fa-plus"></i>   <i class="text-success fa fa-clock"></i> </button>';
            $('#end_time_toggle').html(button);
        ...
        function date_compare() {
            ...
            var start_data = event_start_date[2] + ' ' + event_start_date[1] + ' ' + event_start_date[0] + ' ' +
                event_start_time;
            ...
            if ($('#set_end_date_data').val() == "Yes") {
                ...
                if (start_time > end_time) {
                    ...
                    $('#create_event_alert').show().html(
                        '<div class="alert alert-danger"><a href="" class="close" data-dismiss="alert" aria-label="close">&times;</a>End time must be bigger then Start time</div>'
                        );
                    return false;
                    //   return false;
                ...
                $.ajax({
                    ...
                    success: function(feedback) {
                        ...
                        if (jd.type == 'alert-success') {
                            ...
                            $('#alert_tmeassage_area').show().html('<div class="alert ' + jd.type +
                            ...
                            $('#create_event_alert').show().html('<div class="alert ' + jd.type +
                                '"><a href="" class="close" data-dismiss="alert" aria-label="close">&times;</a>' +
                                msg + '</div>');
                        }
                    }
        ...
        function edit_add_start_time() {
            ...
            var button =
                '<button type="button" title="Remove Start Time"   class="btn btn-md"  onclick="edit_remove_start_time()"><i class="text-danger fa fa-times"></i>   <i class="text-danger fa fa-clock"></i> </button>';
        ...
        function edit_remove_start_time() {
            ...
            var button =
                '<button type="button"  title="Add Start Time"  class="btn btn-md"  onclick="edit_add_start_time()"><i class="text-success fa fa-plus"></i>   <i class="text-success fa fa-clock"></i> </button>';
            $('#edit_start_time_toggle').html(button);
        ...
        function edit_add_end_time() {
            ...
            var button =
                '<button type="button" title="Remove End Time"   class="btn btn-md"  onclick="edit_remove_end_time()"><i class="text-danger fa fa-times"></i>   <i class="text-danger fa fa-clock"></i> </button>';
        ...
        function edit_remove_end_time() {
            ...
            var button =
                '<button type="button" title="Add End Time"   class="btn btn-md"  onclick="edit_add_end_time()"><i class="text-success fa fa-plus"></i>   <i class="text-success fa fa-clock"></i> </button>';
            $('#edit_end_time_toggle').html(button);
                ...
                $.ajax({
                    ...
                    success: function(feedback) {
                        ...
                        if (jd.type == 'alert-success') {
                            ...
                            $('#edit_event_alert').show().html('<div class="alert ' + jd.type +
                                '"><a href="" class="close" data-dismiss="alert" aria-label="close">&times;</a>' +
                                msg + '</div>');
                        }
                    }
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.type == 'alert-success') {
                        $('#alert_tmeassage_area').show().html('<div class="alert ' + response.type +
                            '"><a href="" class="close" data-dismiss="alert" aria-label="close">&times;</a>' +
